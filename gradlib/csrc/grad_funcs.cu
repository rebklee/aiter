 ...
 * hipBLASLt GEMM call
 */
hipblasStatus_t hipblasLtMatmul_wrapper(hipblasLtHandle_t handle,
                                        hipblasOperation_t op_A,
                                        hipblasOperation_t op_B,
                                        int m,
                                        int n,
                ...
                for(int iter{0}; iter < warmup_iters; ++iter)
                {
                    CHECK_HIPBLAS_ERROR(
                        hipblasLtMatmul(handle,
                                        ...
                                        matC,
                                        c,
                                        matC, // In case beta != 0, these runs can overwrite the
                                              // values in c since c and d are the same
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
torch::Tensor hipBLASLtMm_(const torch::Tensor& mat1, const torch::Tensor& mat2)
{
    ...
    CHECK_HIPBLAS_ERROR(hipblasLtMatmul_wrapper(hipblaslt_handle,
